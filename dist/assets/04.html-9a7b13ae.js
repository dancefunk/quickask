import{_ as e,p as i,q as n,Z as d}from"./framework-823c4b5a.js";const s={},l=d(`<h3 id="checkout-放弃修改" tabindex="-1"><a class="header-anchor" href="#checkout-放弃修改" aria-hidden="true">#</a> checkout(放弃修改)</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>checkout放弃的是(git add .)之前还没有放到暂存区的修改
