import{_ as n,p as s,q as a,Y as t}from"./framework-e1bed10d.js";const e={},p=t(`<h3 id="usememo" tabindex="-1"><a class="header-anchor" href="#usememo" aria-hidden="true">#</a> useMemo</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>useMemo 可以作为 Vue 的 computed 来使用。
