import{_ as t,r as p,o as e,c as o,b as n,d as s,e as c,a as i}from"./app-d0ac87ef.js";const l={},u=n("h3",{id:"应用生命周期",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#应用生命周期","aria-hidden":"true"},"#"),s(" 应用生命周期")],-1),r={href:"https://uniapp.dcloud.io/collocation/frame/lifecycle",target:"_blank",rel:"noopener noreferrer"},d=i(`<blockquote><p>应用生命周期仅可在App.vue中监听，在其它页面监听无效。</p></blockquote><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token operator">&lt;</span>script<span class="token operator">&gt;</span>
