import{_ as n,o as s,c as a,a as t}from"./app-f25f351f.js";const p={},e=t(`<h3 id="permission授权" tabindex="-1"><a class="header-anchor" href="#permission授权" aria-hidden="true">#</a> Permission授权</h3><p>很多操作需要用户许可，比如脚本想要知道用户的位置，或者操作用户机器上的摄像头</p><p><code>Permissions API</code>就是用来查询某个接口的许可情况</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 查询地理位置接口的许可情况</span>
