import{_ as r,p as d,q as l,s as e,R as s,t as a,Y as n,n as c}from"./framework-aa5c4115.js";const t={},u=n(`<h3 id="使用-acme-sh-给-nginx-安装-let-s-encrypt-提供的免费-ssl-证书" tabindex="-1"><a class="header-anchor" href="#使用-acme-sh-给-nginx-安装-let-s-encrypt-提供的免费-ssl-证书" aria-hidden="true">#</a> 使用 acme.sh 给 Nginx 安装 Let’ s Encrypt 提供的免费 SSL 证书</h3><h2 id="安装-acme-sh" tabindex="-1"><a class="header-anchor" href="#安装-acme-sh" aria-hidden="true">#</a> 安装 acme.sh</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>curl https://get.acme.sh | sh
