import{_ as n,o as s,c as a,a as p}from"./app-a528498f.js";const e={},t=p(`<h3 id="state" tabindex="-1"><a class="header-anchor" href="#state" aria-hidden="true">#</a> state</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>state 是 react 中用来存储组件数据状态的，可以类比成 vue 中的 data
