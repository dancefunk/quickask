import{_ as e,o as i,c as a,a as n}from"./app-d0ac87ef.js";const d={},t=n(`<h3 id="git的忽略文件的语法规则" tabindex="-1"><a class="header-anchor" href="#git的忽略文件的语法规则" aria-hidden="true">#</a> Git的忽略文件的语法规则</h3><blockquote><p><strong>.gitignore</strong></p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 这是注释行，将被忽略
*.a       # 忽略所有以.a为扩展名的文件    
