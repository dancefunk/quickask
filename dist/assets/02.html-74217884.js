import{_ as e,o as n,c as i,a as d}from"./app-4841f850.js";const l={},a=d(`<h3 id="定义路由" tabindex="-1"><a class="header-anchor" href="#定义路由" aria-hidden="true">#</a> 定义路由</h3><p>URL地址里面的<code>index</code>模块怎么才能省略呢，默认的<code>URL</code>地址显得有点长，下面就来说说如何通过路由简化<code>URL</code>访问。</p><p>我们在路由定义文件（<code>application/route.php</code>）里面添加一些路由规则，如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>return [
