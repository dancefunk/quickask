import{_ as n,p as s,q as a,Z as t}from"./framework-823c4b5a.js";const e={},p=t(`<h3 id="setup" tabindex="-1"><a class="header-anchor" href="#setup" aria-hidden="true">#</a> setup</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>setup 是 Vue3 中新增的钩子，它是我们在编写组件时的一个入口API
