import{_ as n,p as s,q as a,Y as e}from"./framework-e1bed10d.js";const p={},t=e(`<h3 id="基类控制器" tabindex="-1"><a class="header-anchor" href="#基类控制器" aria-hidden="true">#</a> 基类控制器</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>application/common/controller/Api.php //API接口基类控制器
