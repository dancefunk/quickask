import{_ as p,r as o,o as i,c,b as n,d as s,e,a as t}from"./app-1b1b276f.js";const l={},r=n("h3",{id:"本教程的仓库源代码",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#本教程的仓库源代码","aria-hidden":"true"},"#"),s(" 本教程的仓库源代码")],-1),d={href:"https://gitee.com/dancefunk/react.git",target:"_blank",rel:"noopener noreferrer"},u=t(`<h3 id="create-react-app官方脚手架" tabindex="-1"><a class="header-anchor" href="#create-react-app官方脚手架" aria-hidden="true">#</a> create-react-app官方脚手架</h3><blockquote><p>npx安装</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npx create-react-app 项目名称
