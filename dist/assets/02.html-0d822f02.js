import{_ as n,p as s,q as a,Y as e}from"./framework-aa5c4115.js";const t={},p=e(`<h3 id="安装pdo" tabindex="-1"><a class="header-anchor" href="#安装pdo" aria-hidden="true">#</a> 安装PDO</h3><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token constant">PHP5</span>以上已经自带有了php_pdo<span class="token operator">.</span>dll的扩展，不过需要稍微设置一下才能使用。
