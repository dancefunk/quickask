import{_ as n,o as s,c as a,a as t}from"./app-6568e73a.js";const p={},e=t(`<h3 id="字符串拓展" tabindex="-1"><a class="header-anchor" href="#字符串拓展" aria-hidden="true">#</a> 字符串拓展</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// includes 返回布尔值，判断是否找到参数字符串</span>
