import{_ as e,p as n,q as i,Z as d}from"./framework-823c4b5a.js";const s="/assets/node_event_loop-fdd1c856.png",a={},l=d(`<h3 id="基本介绍" tabindex="-1"><a class="header-anchor" href="#基本介绍" aria-hidden="true">#</a> 基本介绍</h3><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code>Node.js 是单进程单线程应用程序，通过事件和回调支持并发，所以性能非常高。
...
处理完成后，会调用事件对应的回调函数
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+s+'" alt="node_event_loop.png"></p>',7),r=[l];function c(v,t){return n(),i("div",null,r)}const u=e(a,[["render",c],["__file","01.html.vue"]]);export{u as default};
