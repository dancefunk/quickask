import{_ as e,o as i,c as n,a as s}from"./app-3c87854f.js";const d={},a=s(`<h3 id="数据库操作" tabindex="-1"><a class="header-anchor" href="#数据库操作" aria-hidden="true">#</a> 数据库操作</h3><p>数据库的配置文件放置在 <code>config/database.php</code> 文件中，你可以在此定义所有的数据库连接，并指定默认使用的连接。此文件内提供了大部分 Laravel 能支持的数据库配置示例。</p><h3 id="curd查询构造器" tabindex="-1"><a class="header-anchor" href="#curd查询构造器" aria-hidden="true">#</a> CURD查询构造器</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;?php
