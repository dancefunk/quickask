import{_ as e,p as i,q as n,Y as s}from"./framework-e1bed10d.js";const d={},a=s(`<h3 id="linux-svn搭建配置钩子自动更新" tabindex="-1"><a class="header-anchor" href="#linux-svn搭建配置钩子自动更新" aria-hidden="true">#</a> linux svn搭建配置钩子自动更新</h3><h2 id="_1、安装svn服务器端" tabindex="-1"><a class="header-anchor" href="#_1、安装svn服务器端" aria-hidden="true">#</a> 1、安装svn服务器端</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>yum install subversion  
