import{_ as n,p as s,q as a,Y as e}from"./framework-aa5c4115.js";const p="/assets/1-6cb48075.png",t={},o=e(`<h3 id="基本语法" tabindex="-1"><a class="header-anchor" href="#基本语法" aria-hidden="true">#</a> 基本语法</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>Javascipt是一种动态、弱类型、基于原型的脚本语言，由web浏览器进行解释和执行
...
<span class="token function">alert</span><span class="token punctuation">(</span>‘hello wordld’<span class="token punctuation">)</span><span class="token punctuation">;</span>
