import{_ as n,o as s,c as a,a as e}from"./app-9f8282b6.js";const t={},p=e(`<h3 id="声明文件的定义" tabindex="-1"><a class="header-anchor" href="#声明文件的定义" aria-hidden="true">#</a> 声明文件的定义</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>通俗地来讲，在 TypeScript 中以 <span class="token punctuation">.</span>d<span class="token punctuation">.</span>ts 为后缀的文件，我们称之为 TypeScript 声明文件。
