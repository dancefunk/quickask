import{_ as s,o as n,c as a,a as e}from"./app-d0ac87ef.js";const t="/dist/assets/images/mysql/2.png",p="/dist/assets/images/mysql/3.png",l="/dist/assets/images/mysql/4.png",i={},o=e(`<h3 id="myisam表锁" tabindex="-1"><a class="header-anchor" href="#myisam表锁" aria-hidden="true">#</a> MyISAM表锁</h3><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code>MySQL的表级锁有两种模式：表共享读锁（Table Read Lock）和表独占写锁（Table Write Lock）。
