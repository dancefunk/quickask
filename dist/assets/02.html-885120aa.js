import{_ as n,o as s,c as a,a as e}from"./app-f46aa08f.js";const p={},t=e(`<h3 id="使用场景" tabindex="-1"><a class="header-anchor" href="#使用场景" aria-hidden="true">#</a> 使用场景</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>当我们在React项目开发当中，经常会去调用后端的接口，所以我们在React搭建的过程中，需要对接口请求进行封装
