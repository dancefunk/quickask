import{_ as e,p as i,q as n,Y as s}from"./framework-aa5c4115.js";const d={},l=s(`<h3 id="时间处理模块-moment" tabindex="-1"><a class="header-anchor" href="#时间处理模块-moment" aria-hidden="true">#</a> 时间处理模块(Moment)</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>安装
