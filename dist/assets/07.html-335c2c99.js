import{_ as n,p as s,q as a,Y as t}from"./framework-e1bed10d.js";const e={},p=t(`<h3 id="数据响应式原理" tabindex="-1"><a class="header-anchor" href="#数据响应式原理" aria-hidden="true">#</a> 数据响应式原理</h3><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code>Mutation Observer API 用来监视 DOM 变动
