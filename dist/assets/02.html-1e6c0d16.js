import{_ as n,o as s,c as a,a as t}from"./app-3e5ace64.js";const e={},p=t(`<h3 id="几组常见的输入输出函数" tabindex="-1"><a class="header-anchor" href="#几组常见的输入输出函数" aria-hidden="true">#</a> 几组常见的输入输出函数</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>printf 与 scanf
getchar 与 putchar
gets 与 puts
