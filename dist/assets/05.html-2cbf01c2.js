import{_ as n,p as s,q as a,Z as e}from"./framework-823c4b5a.js";const t={},l=e(`<h3 id="模块系统" tabindex="-1"><a class="header-anchor" href="#模块系统" aria-hidden="true">#</a> 模块系统</h3><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code>为了让nodejs的文件可以相互调用，nodejs提供了模块系统
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,15),p=[l];function i(o,c){return s(),a("div",null,p)}const d=n(t,[["render",i],["__file","05.html.vue"]]);export{d as default};
