import{_ as n,o as s,c as a,a as e}from"./app-f25f351f.js";const t="/dist/assets/images/php/composer/tag.png",i="/dist/assets/images/php/composer/submit.jpg",p="/dist/assets/images/php/composer/composer.png",o={},l=e(`<h3 id="准备材料" tabindex="-1"><a class="header-anchor" href="#准备材料" aria-hidden="true">#</a> 准备材料</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1、注册(Gitee、Github) 2选1的平台的账号
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,34),c=[l];function u(r,d){return s(),a("div",null,c)}const m=n(o,[["render",u],["__file","02.html.vue"]]);export{m as default};
