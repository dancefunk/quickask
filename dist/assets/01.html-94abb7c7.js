import{_ as e,p as a,q as n,Y as s}from"./framework-e1bed10d.js";const i={},d=s(`<h3 id="mysql数据锁" tabindex="-1"><a class="header-anchor" href="#mysql数据锁" aria-hidden="true">#</a> Mysql数据锁</h3><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code>Mysql表锁
Mysql行锁
Mysql页面锁
Mysql共享锁
Mysql排它锁
