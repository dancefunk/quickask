import{_ as n,o as i,c as e,a as d}from"./app-47c2ac71.js";const s={},l=d(`<h2 id="函数列表" tabindex="-1"><a class="header-anchor" href="#函数列表" aria-hidden="true">#</a> 函数列表</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>bcadd — 将两个高精度数字相加
