import{_ as e,p as i,q as n,Y as s}from"./framework-e1bed10d.js";const d="/assets/mvc-48c93774.png",a="/assets/mvvm-e2c83cfe.png",l={},c=s(`<h3 id="mvc" tabindex="-1"><a class="header-anchor" href="#mvc" aria-hidden="true">#</a> MVC</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>视图（View）：用户界面
控制器（Controller）：业务逻辑
模型（Model）：数据保存
