import{_ as e,o as i,c as d,a as n}from"./app-9f8282b6.js";const s={},t=n(`<h3 id="定义控制器" tabindex="-1"><a class="header-anchor" href="#定义控制器" aria-hidden="true">#</a> 定义控制器</h3><p>下面是一个基础控制器类的例子。需要注意的是，该控制器继承了一个Laravel内置的基础控制器类。该基础控制器提供了一些编辑的方法，比如 <code>middleware</code> 方法，该方法可以为控制器行为添加中间件：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;?php
