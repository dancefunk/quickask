import{_ as e,p as t,q as i,s as n,R as a,t as l,Y as c,n as p}from"./framework-e1bed10d.js";const o={},r=n("h3",{id:"babel官网文档",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#babel官网文档","aria-hidden":"true"},"#"),a(" Babel官网文档")],-1),d={href:"https://www.babeljs.cn/",target:"_blank",rel:"noopener noreferrer"},u=c(`<h3 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>什么是Babel?
...
如果不配置env选项，该转译器等同于babel-preset-latest。
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23);function v(b,k){const s=p("ExternalLinkIcon");return t(),i("div",null,[r,n("blockquote",null,[n("ul",null,[n("li",null,[n("a",d,[a("https://www.babeljs.cn/"),l(s)])])])]),u])}const h=e(o,[["render",v],["__file","02.html.vue"]]);export{h as default};
