import{_ as e,p as i,q as n,Y as s}from"./framework-aa5c4115.js";const d={},l=s(`<h3 id="session" tabindex="-1"><a class="header-anchor" href="#session" aria-hidden="true">#</a> session</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>一次性session(验证提示)
