import{_ as s,p as r,q as a,s as e,R as i,t as d,Z as l,n as t}from"./framework-823c4b5a.js";const c={},u=e("h3",{id:"homebrew",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#homebrew","aria-hidden":"true"},"#"),i(" HomeBrew")],-1),v={href:"https://brew.sh/",target:"_blank",rel:"noopener noreferrer"},b=l(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Homebrew 是 Linux 下套件管理工具。有点类似于一个应用中心
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,25);function m(o,h){const n=t("ExternalLinkIcon");return r(),a("div",null,[u,e("blockquote",null,[e("ul",null,[e("li",null,[e("a",v,[i("HomeBrew官网地址"),d(n)])])])]),b])}const w=s(c,[["render",m],["__file","Homebrew(Mac).html.vue"]]);export{w as default};
