import{_ as l,p as o,q as i,s as n,R as s,t as e,Y as t,n as p}from"./framework-e1bed10d.js";const c={},r=n("h3",{id:"nodejs-模板引擎",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nodejs-模板引擎","aria-hidden":"true"},"#"),s(" NodeJS-模板引擎")],-1),d=n("h3",{id:"xtpl-和-xtemplate-使用",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#xtpl-和-xtemplate-使用","aria-hidden":"true"},"#"),s(" Xtpl 和 xtemplate 使用")],-1),u={href:"https://github.com/xtemplate/xtpl",target:"_blank",rel:"noopener noreferrer"},v={href:"https://github.com/xtemplate/xtemplate",target:"_blank",rel:"noopener noreferrer"},m=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>$ npm install xtpl --save
