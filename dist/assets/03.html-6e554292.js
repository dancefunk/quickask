import{_ as n,o as s,c as e,a}from"./app-6568e73a.js";const t={},i=a(`<h3 id="使用场景" tabindex="-1"><a class="header-anchor" href="#使用场景" aria-hidden="true">#</a> 使用场景</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>有些时候，我们需要将自己封装的composer包安装到指定的目录
