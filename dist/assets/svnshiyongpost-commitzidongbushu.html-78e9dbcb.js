import{_ as e,p as s,q as n,Y as i}from"./framework-e1bed10d.js";const t={},o=i(`<h5 id="post-commit-bat" tabindex="-1"><a class="header-anchor" href="#post-commit-bat" aria-hidden="true">#</a> post-commit.bat</h5><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@echo off
SET REPOS=%1
SET REV=%2
SET DIR=%REPOS%/hooks
