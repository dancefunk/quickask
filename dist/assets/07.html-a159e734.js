import{_ as n,o as s,c as a,a as e}from"./app-6568e73a.js";const t={},p=e(`<h3 id="set-与-map" tabindex="-1"><a class="header-anchor" href="#set-与-map" aria-hidden="true">#</a> Set 与 Map</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Set 和 Map 主要的应用场景在于 数据重组 和 数据储存。
