import{_ as e,r as t,o as p,c as i,b as n,d as s,e as o,a as l}from"./app-1b1b276f.js";const c={},r=n("h3",{id:"vue-router",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue-router","aria-hidden":"true"},"#"),s(" Vue-Router")],-1),u={href:"https://router.vuejs.org/zh/",target:"_blank",rel:"noopener noreferrer"},d=l(`<h3 id="安装vuerouter4" tabindex="-1"><a class="header-anchor" href="#安装vuerouter4" aria-hidden="true">#</a> 安装VueRouter4</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install vue-router@4 -S
