import{_ as n,p as s,q as a,Z as e}from"./framework-823c4b5a.js";const t={},p=e(`<h3 id="生产环境下js会自动压缩" tabindex="-1"><a class="header-anchor" href="#生产环境下js会自动压缩" aria-hidden="true">#</a> 生产环境下JS会自动压缩</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mode: production
