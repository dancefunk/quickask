import{_ as s,o as n,c as e,a}from"./app-c220f801.js";const i={},t=a(`<h3 id="css基础知识" tabindex="-1"><a class="header-anchor" href="#css基础知识" aria-hidden="true">#</a> CSS基础知识</h3><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code>CSS是Cascading Style Sheet（层叠样式表）的缩写
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10),c=[t];function l(d,u){return n(),e("div",null,c)}const r=s(i,[["render",l],["__file","01.html.vue"]]);export{r as default};
