import{_ as n,o as s,c as a,a as t}from"./app-3c87854f.js";const e={},p=t(`<h3 id="路由守卫" tabindex="-1"><a class="header-anchor" href="#路由守卫" aria-hidden="true">#</a> 路由守卫</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>我们经常会用到路由守卫这个功能，来帮助我们判断用户的状态是否有登录，如果有登录就进入到路由界面。
如果没有的话就跳转到登录界面
