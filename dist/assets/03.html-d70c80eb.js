import{_ as e,p,q as o,s as n,R as s,t,Y as l,n as i}from"./framework-aa5c4115.js";const c={},u=n("h3",{id:"转载地址",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#转载地址","aria-hidden":"true"},"#"),s(" 转载地址")],-1),r={href:"https://yejiwei.com/post/193",target:"_blank",rel:"noopener noreferrer"},d={href:"https://blog.xiaolong0418.com/blogs/18",target:"_blank",rel:"noopener noreferrer"},k=n("h3",{id:"vite构建工具",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vite构建工具","aria-hidden":"true"},"#"),s(" Vite构建工具")],-1),v={href:"https://vitejs.cn/",target:"_blank",rel:"noopener noreferrer"},m=l(`<h3 id="vite配置" tabindex="-1"><a class="header-anchor" href="#vite配置" aria-hidden="true">#</a> Vite配置</h3><blockquote><p>vite.config.js 简易配置</p></blockquote><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> defineConfig <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;vite&#39;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,65);function b(g,y){const a=i("ExternalLinkIcon");return p(),o("div",null,[u,n("ul",null,[n("li",null,[n("a",r,[s("Vite零基础快速入门"),t(a)])]),n("li",null,[n("a",d,[s("Vite快速入门教程"),t(a)])])]),k,n("p",null,[n("a",v,[s("https://vitejs.cn/"),t(a)])]),m])}const h=e(c,[["render",b],["__file","03.html.vue"]]);export{h as default};
