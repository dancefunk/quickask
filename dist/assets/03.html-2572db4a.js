import{_ as n,p as s,q as a,Y as e}from"./framework-aa5c4115.js";const t={},i=e(`<h3 id="自动化测试分类" tabindex="-1"><a class="header-anchor" href="#自动化测试分类" aria-hidden="true">#</a> 自动化测试分类</h3><h3 id="单元测试" tabindex="-1"><a class="header-anchor" href="#单元测试" aria-hidden="true">#</a> 单元测试</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>单元测试（unit testing）是指对软件中的最小可测试单元进行检查和验证。
