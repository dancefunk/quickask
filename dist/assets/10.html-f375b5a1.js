import{_ as i,o as n,c as e,a as s}from"./app-d0ac87ef.js";const l={},d=s(`<h3 id="nginx虚拟主机配置" tabindex="-1"><a class="header-anchor" href="#nginx虚拟主机配置" aria-hidden="true">#</a> Nginx虚拟主机配置</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>server
    {
        listen 80;
        #listen [::]:80;
