import{_ as n,p as s,q as a,Y as t}from"./framework-e1bed10d.js";const e={},p=t(`<h3 id="setup" tabindex="-1"><a class="header-anchor" href="#setup" aria-hidden="true">#</a> setup</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>setup 是 Vue3 中新增的钩子，它是我们在编写组件时的一个入口API
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
	...
	<span class="token comment">// defineProps()   获取组件传参属性API</span>
	<span class="token comment">// defineEmits()   获取组件传参执行器API</span>
