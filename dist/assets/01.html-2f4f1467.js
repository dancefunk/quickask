import{_ as n,p as s,q as a,Y as e}from"./framework-e1bed10d.js";const p={},t=e(`<h3 id="过程式编程" tabindex="-1"><a class="header-anchor" href="#过程式编程" aria-hidden="true">#</a> 过程式编程</h3><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code>初学编程的方法通常由顺序结构开始。
