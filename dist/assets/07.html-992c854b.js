import{_ as i,p as e,q as n,Y as l}from"./framework-e1bed10d.js";const d={},s=l(`<h3 id="打包上线" tabindex="-1"><a class="header-anchor" href="#打包上线" aria-hidden="true">#</a> 打包上线</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>我们通过打包命令，将项目进行打包压缩，那么生成的路径是：build/
