import{_ as e,o as d,c as i,a as n}from"./app-c220f801.js";const a={},s=n(`<h3 id="获取请求" tabindex="-1"><a class="header-anchor" href="#获取请求" aria-hidden="true">#</a> 获取请求</h3><p>要通过依赖注入的方式来获取当前 HTTP 请求的实例，你应该在控制器方法中引入 <code>Illuminate\\Http\\Request</code> 类。传入的请求实例将通过 服务容器 自动注入:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;?php
