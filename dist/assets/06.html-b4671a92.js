import{_ as n,o as s,c as a,a as t}from"./app-b57ef521.js";const p={},e=t(`<h3 id="usecallback" tabindex="-1"><a class="header-anchor" href="#usecallback" aria-hidden="true">#</a> useCallback</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>useCallback的作用主要是 数据缓存，当缓存的状态数据，发生改变时才会刷新数据，如果缓存的状态数据没有发生改变。
