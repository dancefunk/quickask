import{_ as e,o,c as t,a as d}from"./app-d0ac87ef.js";const u={},a=d(`<h3 id="导入数据" tabindex="-1"><a class="header-anchor" href="#导入数据" aria-hidden="true">#</a> 导入数据</h3><p>本教程使用test数据库和restaurants集合为例进行讲解。下面是restaurants的一个文档结构示例：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>{
  &quot;address&quot;: {
     &quot;building&quot;: &quot;1007&quot;,
