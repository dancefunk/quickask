import{_ as e,p as o,q as t,s as n,R as i,t as r,Y as s,n as p}from"./framework-aa5c4115.js";const l={},c=s(`<h3 id="什么是bower" tabindex="-1"><a class="header-anchor" href="#什么是bower" aria-hidden="true">#</a> 什么是bower</h3><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code>Bower 是用于 web 前端开发的包管理器。对于前端包管理方面的问题，它提供了一套通用、客观的解决方案。
