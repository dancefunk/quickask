import{_ as n,o as s,c as a,a as t}from"./app-c220f801.js";const e={},p=t(`<h3 id="mysql存储过程" tabindex="-1"><a class="header-anchor" href="#mysql存储过程" aria-hidden="true">#</a> Mysql存储过程</h3><ul><li><strong>MySQL存储过程简介</strong></li><li><strong>MySQL存储过程入门</strong></li><li><strong>MySQL存储过程变量</strong></li><li><strong>MySQL存储过程参数</strong></li><li><strong>数据类型及运算符</strong></li><li><strong>存储过程中的Mysql流程语句</strong></li><li><strong>存储过程中的MySQL循环</strong></li><li><strong>MySQL游标</strong></li><li><strong>存储过程中的MySQL错误处理</strong></li><li><strong>MySQL存储函数</strong></li></ul><h3 id="mysql存储过程简介" tabindex="-1"><a class="header-anchor" href="#mysql存储过程简介" aria-hidden="true">#</a> MySQL存储过程简介</h3><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code>存储过程是一组为了完成特定功能的<span class="token constant">SQL</span>语句集，经编译后存储在数据库中。
