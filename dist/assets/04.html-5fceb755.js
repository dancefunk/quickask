import{_ as e,o as i,c as n,a as s}from"./app-d50584af.js";const d={},a=s(`<h3 id="请求信息" tabindex="-1"><a class="header-anchor" href="#请求信息" aria-hidden="true">#</a> 请求信息</h3><p>如果要获取当前的请求信息，可以使用<code>\\think\\Request</code>类</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>$request = Request::instance();
