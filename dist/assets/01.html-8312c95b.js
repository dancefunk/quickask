import{_ as n,o as s,c as a,a as e}from"./app-6568e73a.js";const p={},t=e(`<h3 id="变量数据类型" tabindex="-1"><a class="header-anchor" href="#变量数据类型" aria-hidden="true">#</a> 变量数据类型</h3><h3 id="php标记" tabindex="-1"><a class="header-anchor" href="#php标记" aria-hidden="true">#</a> php标记</h3><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span> <span class="token keyword">echo</span> <span class="token string single-quoted-string">&#39;hello&#39;</span><span class="token punctuation">;</span> <span class="token delimiter important">?&gt;</span></span>
