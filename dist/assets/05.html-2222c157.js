import{_ as e,o as i,c as n,a as d}from"./app-6325e707.js";const t={},l=d(`<h3 id="数据库配置" tabindex="-1"><a class="header-anchor" href="#数据库配置" aria-hidden="true">#</a> 数据库配置</h3><p>我们给应用定义数据库配置文件（<code>appliation/database.php</code>），里面设置了应用的全局数据库配置信息。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>return [
    // 数据库类型
    &#39;type&#39;        =&gt; &#39;mysql&#39;,
    // 服务器地址
    &#39;hostname&#39;    =&gt; &#39;127.0.0.1&#39;,
