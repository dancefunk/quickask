import{_ as n,p as s,q as a,Y as e}from"./framework-aa5c4115.js";const t={},p=e(`<h3 id="if条件语句" tabindex="-1"><a class="header-anchor" href="#if条件语句" aria-hidden="true">#</a> if条件语句</h3><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">p</span> <span class="token punctuation">{</span>
