import{_ as e,p as t,q as p,s as n,R as s,t as o,Y as c,n as l}from"./framework-e1bed10d.js";const i={},r=n("h3",{id:"nodemailer邮件发送",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nodemailer邮件发送","aria-hidden":"true"},"#"),s(" NodeMailer邮件发送")],-1),u={href:"https://nodemailer.com/",target:"_blank",rel:"noopener noreferrer"},k=c(`<h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install nodemailer --save
