import{_ as p,p as l,q as i,s as n,R as s,t,Y as e,n as c}from"./framework-e1bed10d.js";const o="/assets/rem-5e7558f2.jpg",u={},d=e(`<h3 id="重置样式" tabindex="-1"><a class="header-anchor" href="#重置样式" aria-hidden="true">#</a> 重置样式</h3><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">HTML标签在浏览器里有默认的样式,例如p标签有上下边距
