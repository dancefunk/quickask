...
<span class="token number">5</span>，m<span class="token punctuation">:</span>n 把两边的主键放到一个新的关系表 里 做外键
    ...
    数据表里没有 等重复的数据列<span class="token punctuation">;</span>
    数据表的空间占用总量越小越好<span class="token punctuation">;</span> order1<span class="token punctuation">,</span> order2<span class="token punctuation">,</span> order3
