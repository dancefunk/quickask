import{_ as n,o as s,c as a,a as t}from"./app-d0ac87ef.js";const p={},e=t(`<h3 id="事件处理" tabindex="-1"><a class="header-anchor" href="#事件处理" aria-hidden="true">#</a> 事件处理</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>React 元素的事件处理和 DOM 元素类似。但是有一点语法上的不同:
