import{_ as n,o as s,c as e,a}from"./app-6325e707.js";const i={},l=a(`<h3 id="表引擎" tabindex="-1"><a class="header-anchor" href="#表引擎" aria-hidden="true">#</a> 表引擎</h3><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code>MySQL的强大之处在于它的插件式存储引擎，我们可以基于表的特点使用不同的存储引擎，从而达到最好的性能。
