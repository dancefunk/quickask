import{_ as e,o as n,c as i,a as d}from"./app-b57ef521.js";const s={},a=d(`<h3 id="控制器" tabindex="-1"><a class="header-anchor" href="#控制器" aria-hidden="true">#</a> 控制器</h3><p>ThinkPHP V5.0的控制器定义比较灵活，可以无需继承任何的基础类，也可以继承官方封装的<code>\\think\\Controller</code>类或者其他的控制器类。</p><h3 id="修改控制器系统配置" tabindex="-1"><a class="header-anchor" href="#修改控制器系统配置" aria-hidden="true">#</a> 修改控制器系统配置</h3><blockquote><ul><li>配置文件路径：application\\config.php</li></ul></blockquote><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token comment">// 自动搜索控制器</span>
