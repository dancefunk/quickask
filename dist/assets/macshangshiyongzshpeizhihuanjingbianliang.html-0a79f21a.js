import{_ as n,o as i,c as s,a}from"./app-11dfbba7.js";const e={},l=a(`<h3 id="mac配置环境变量的地方-每次重启命令行都会重新在环境文件" tabindex="-1"><a class="header-anchor" href="#mac配置环境变量的地方-每次重启命令行都会重新在环境文件" aria-hidden="true">#</a> Mac配置环境变量的地方，每次重启命令行都会重新在环境文件</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>~/.zprofile
~/.profile
