import{_ as e,p as i,q as s,Y as n}from"./framework-e1bed10d.js";const a="/assets/gitee-ssh-key-5b4b7819.png",d="/assets/github-token-9d717ebd.png",t={},l=n(`<h3 id="创建秘钥文件" tabindex="-1"><a class="header-anchor" href="#创建秘钥文件" aria-hidden="true">#</a> 创建秘钥文件</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>ssh-keygen -t rsa -C &quot;你的邮箱&quot;
