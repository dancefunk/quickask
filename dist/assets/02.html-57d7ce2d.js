import{_ as n,o as s,c as a,a as e}from"./app-da5bd584.js";const t={},i=e(`<h3 id="ddl数据定义语言" tabindex="-1"><a class="header-anchor" href="#ddl数据定义语言" aria-hidden="true">#</a> DDL数据定义语言</h3><h3 id="数据库操作" tabindex="-1"><a class="header-anchor" href="#数据库操作" aria-hidden="true">#</a> 数据库操作</h3><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code>显示数据库列表
