import{_ as a,r as t,o as i,c,b as n,d as s,e as l,a as d}from"./app-d0ac87ef.js";const r={},o=n("h3",{id:"css实战特效",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#css实战特效","aria-hidden":"true"},"#"),s(" CSS实战特效")],-1),u={href:"https://gitee.com/dancefunk/quickask-web-base",target:"_blank",rel:"noopener noreferrer"},p=d(`<h3 id="css基础知识" tabindex="-1"><a class="header-anchor" href="#css基础知识" aria-hidden="true">#</a> CSS基础知识</h3><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code>CSS是Cascading Style Sheet（层叠样式表）的缩写
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10);function v(b,m){const e=t("ExternalLinkIcon");return i(),c("div",null,[o,n("p",null,[n("strong",null,[n("a",u,[s("仓库地址：https://gitee.com/dancefunk/quickask-web-base"),l(e)])])]),p])}const g=a(r,[["render",v],["__file","01.html.vue"]]);export{g as default};
