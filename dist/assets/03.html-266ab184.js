import{_ as n,o as s,c as a,a as e}from"./app-f25f351f.js";const t={},i=e(`<h3 id="使用场景" tabindex="-1"><a class="header-anchor" href="#使用场景" aria-hidden="true">#</a> 使用场景</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>有些时候，我们需要将自己封装的composer包安装到指定的目录
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,16),o=[i];function l(p,r){return s(),a("div",null,o)}const d=n(t,[["render",l],["__file","03.html.vue"]]);export{d as default};
