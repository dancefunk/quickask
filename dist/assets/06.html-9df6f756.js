import{_ as e,o as i,c as n,a as s}from"./app-6f490402.js";const d={},l=s(`<h3 id="模型-验证器" tabindex="-1"><a class="header-anchor" href="#模型-验证器" aria-hidden="true">#</a> 模型&amp;&amp;验证器</h3><h4 id="定义一个user模型类" tabindex="-1"><a class="header-anchor" href="#定义一个user模型类" aria-hidden="true">#</a> 定义一个User模型类：</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>namespace app\\index\\model;
