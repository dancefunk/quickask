import{_ as n,o as s,c as a,a as p}from"./app-4841f850.js";const e={},t=p(`<h3 id="文件上传的相关配置" tabindex="-1"><a class="header-anchor" href="#文件上传的相关配置" aria-hidden="true">#</a> 文件上传的相关配置</h3><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code>表单设置
