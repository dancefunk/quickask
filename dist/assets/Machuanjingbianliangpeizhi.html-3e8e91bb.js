import{_ as e,r as i,o as l,c as p,b as s,d as n,e as t,a as c}from"./app-a528498f.js";const r={},o=s("h3",{id:"参考链接",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#参考链接","aria-hidden":"true"},"#"),n(" 参考链接")],-1),d={href:"https://vic.kim/2021/04/25/Mac%E7%8E%AF%E5%A2%83%E5%8F%98%E9%87%8F%E9%85%8D%E7%BD%AE/",target:"_blank",rel:"noopener noreferrer"},v=c(`<h3 id="mac环境变量配置" tabindex="-1"><a class="header-anchor" href="#mac环境变量配置" aria-hidden="true">#</a> Mac环境变量配置</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Mac一般使用bash作为默认shell，如果安装了oh my sh，则默认使用zshshell
