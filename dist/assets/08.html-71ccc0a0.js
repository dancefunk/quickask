import{_ as e,p as n,q as i,Y as s}from"./framework-aa5c4115.js";const a={},t=s(`<h3 id="一键生成crud" tabindex="-1"><a class="header-anchor" href="#一键生成crud" aria-hidden="true">#</a> 一键生成CRUD</h3><blockquote><p>在FastAdmin中可以快速的一键生成CRUD，其中包括控制器、模型、视图、验证器、语言包、JS</p></blockquote><h4 id="准备工作" tabindex="-1"><a class="header-anchor" href="#准备工作" aria-hidden="true">#</a> 准备工作</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>在数据库中创建一个fa_test数据表，编辑好表字段结构，并且一定写上字段注释和表注释
