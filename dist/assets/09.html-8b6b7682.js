import{_ as n,o as s,c as a,a as t}from"./app-47c2ac71.js";const p={},e=t(`<h3 id="父子组件通信" tabindex="-1"><a class="header-anchor" href="#父子组件通信" aria-hidden="true">#</a> 父子组件通信</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>父传子 - 用属性(props)
子传父 - 用事件(event)
