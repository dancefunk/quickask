import{_ as e,o as i,c as n,a as s}from"./app-f25f351f.js";const l={},d=s(`<h3 id="nodejs使用async-await同步操作mysql" tabindex="-1"><a class="header-anchor" href="#nodejs使用async-await同步操作mysql" aria-hidden="true">#</a> nodejs使用async/await同步操作mysql</h3><blockquote><ul><li>npm install mysql --save</li></ul></blockquote><h3 id="创建mysql连接" tabindex="-1"><a class="header-anchor" href="#创建mysql连接" aria-hidden="true">#</a> 创建mysql连接</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>const mysql      = require(&#39;mysql&#39;)
