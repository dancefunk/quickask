import{_ as e,o as i,c as n,a as d}from"./app-da5bd584.js";const a={},s=d(`<h3 id="缓存" tabindex="-1"><a class="header-anchor" href="#缓存" aria-hidden="true">#</a> 缓存</h3><p>ThinkPHP采用<code>think\\Cache</code>类提供缓存功能支持。</p><h4 id="设置" tabindex="-1"><a class="header-anchor" href="#设置" aria-hidden="true">#</a> 设置</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>$options = [
    // 缓存类型为File
    &#39;type&#39;  =&gt;  &#39;File&#39;, 
    // 缓存有效期为永久有效
    &#39;expire&#39;=&gt;  0, 
