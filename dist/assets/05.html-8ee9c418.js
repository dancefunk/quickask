import{_ as n,p as s,q as a,Z as e}from"./framework-823c4b5a.js";const t={},p=e(`<h3 id="抽象类" tabindex="-1"><a class="header-anchor" href="#抽象类" aria-hidden="true">#</a> 抽象类</h3><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code>抽象类是指含有抽象方法（即没有函数体的方法）的类
