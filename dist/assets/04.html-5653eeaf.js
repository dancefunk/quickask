import{_ as n,p as s,q as a,Y as t}from"./framework-e1bed10d.js";const p={},e=t(`<h3 id="vue组件的api风格" tabindex="-1"><a class="header-anchor" href="#vue组件的api风格" aria-hidden="true">#</a> Vue组件的API风格</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>选项式API
