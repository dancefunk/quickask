import{_ as e,r as t,o as p,c as o,b as n,d as s,e as c,a as l}from"./app-47c2ac71.js";const i={},r=n("h3",{id:"nodemailer邮件发送",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nodemailer邮件发送","aria-hidden":"true"},"#"),s(" NodeMailer邮件发送")],-1),u={href:"https://nodemailer.com/",target:"_blank",rel:"noopener noreferrer"},d=l(`<h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install nodemailer --save
