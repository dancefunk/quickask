import{_ as n,o as s,c as a,a as e}from"./app-1b1b276f.js";const t={},p=e(`<h3 id="useref-绑定页面的dom元素" tabindex="-1"><a class="header-anchor" href="#useref-绑定页面的dom元素" aria-hidden="true">#</a> useRef(绑定页面的DOM元素)</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>返回一个可变的 ref 对象，该对象只有个 current 属性，初始值为传入的参数( initialValue )。
