import{_ as s,o as n,c as a,a as e}from"./app-c94bd78a.js";const i={},t=e(`<h3 id="第三方部署模块" tabindex="-1"><a class="header-anchor" href="#第三方部署模块" aria-hidden="true">#</a> 第三方部署模块</h3><ul><li>pm2</li><li>forever</li></ul><h3 id="使用场合" tabindex="-1"><a class="header-anchor" href="#使用场合" aria-hidden="true">#</a> 使用场合</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>forever管理多个站点，每个站点访问量不大，不需要监控
