import{_ as e,p as a,q as i,Y as d}from"./framework-e1bed10d.js";const n={},s=d(`<h3 id="查看远程版本库信息" tabindex="-1"><a class="header-anchor" href="#查看远程版本库信息" aria-hidden="true">#</a> 查看远程版本库信息</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>git remote -v
