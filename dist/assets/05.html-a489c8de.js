import{_ as t,p,q as o,s as n,R as s,t as e,Z as i,n as c}from"./framework-823c4b5a.js";const l={},u=n("h3",{id:"友情参考",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#友情参考","aria-hidden":"true"},"#"),s(" 友情参考")],-1),r={href:"http://itrain.top/2020/07/engineering_express_mock_server/",target:"_blank",rel:"noopener noreferrer"},d=n("h3",{id:"mockjs",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#mockjs","aria-hidden":"true"},"#"),s(" Mockjs")],-1),k={href:"http://mockjs.com/",target:"_blank",rel:"noopener noreferrer"},v=i(`<p>提供了以下模拟功能：</p><ul><li>根据数据模板生成模拟数据</li><li>模拟 Ajax 请求，生成并返回模拟数据</li><li>基于 HTML 模板生成模拟数据</li></ul><h3 id="安装nodemon" tabindex="-1"><a class="header-anchor" href="#安装nodemon" aria-hidden="true">#</a> 安装nodemon</h3><blockquote><p>开发时会经常修改开发代码并即时测试，手动重启服务器较麻烦，可安装nodemon来监视文件的变化自动编译</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i nodemon -g
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,31);function m(b,g){const a=c("ExternalLinkIcon");return p(),o("div",null,[u,n("ul",null,[n("li",null,[n("a",r,[s("利用 Express 搭建 Mock 服务器"),e(a)])])]),d,n("p",null,[n("a",k,[s("Mock.js"),e(a)]),s("是一款模拟数据生成器，帮助前端开发者独立于后端进行开发，帮助编写单元测试")]),v])}const q=t(l,[["render",m],["__file","05.html.vue"]]);export{q as default};
